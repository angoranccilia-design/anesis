...
export function getCopy(lang: Lang) {
  return {
    nav: {
      ...
      tagline: p(lang, "An underwriting firm for independent hospitality", "Une firme d'acquisition pour l'hôtellerie indépendante"),
    },
    footer: {
      blurb: p(
        lang,
        ...
        "Une firme d'acquisition pour l'hôtellerie indépendante britannique — hôtels, spas, retraites, glamping et petits resorts. Nous mesurons, en livres, le revenu direct que vous perdez au profit de Booking.com et des autres OTA, et nous assumons la responsabilité financière de le récupérer.",
      ),
    ...
    home: {
      eyebrow: p(lang, "Direct bookings for independent UK hospitality", "Réservations directes pour l'hôtellerie indépendante au Royaume-Uni"),
    ...
    about: {
      ...
      title: p(lang, "An underwriting firm for independent hospitality.", "Une firme d'acquisition pour l'hôtellerie indépendante."),
      lede: p(
        lang,
    ...
    method: {
      ...
      lede: p(
        ...
        "L'Anesis Revenue Leak Index examine cinq domaines où l'hôtellerie indépendante perd des réservations directes. Nous mesurons chacun sur vos données réelles, puis construisons le plan autour de ce que nous trouvons.",
      ),
