    ...
    <>
      ...
      <section className="pt-36 pb-10">
        <div className="container-editorial text-center">
          <Image src="/crest.jpg" alt="" width={160} height={131} className="mx-auto h-auto w-16 mix-blend-multiply" />
          ...
          <div className="mt-4 flex items-center justify-center gap-4 font-sans text-[0.7rem] uppercase tracking-eyebrow text-gold-deep">
            ...
            <span className="h-1 w-1 rounded-full bg-gold" />
            <span>Hospitality Underwriting</span>
          </div>
          ...
          <p className="mx-auto mt-6 max-w-2xl font-serif text-xl font-light italic leading-relaxed text-forest-800/80">
            Written this month with the rigour of a broadsheet, not the haste of a blog — on where the
            money quietly leaves a hotel of character, and what is recoverable.
          </p>
        </div>
      </section>
        ...
        <div className="container-editorial">
          <Reveal>
            <Link href={`/journal/${lead.slug}`} className="group block">
              <p className="eyebrow">This month’s lead</p>
              ...
              <p className="mt-5 font-sans text-sm text-gold-deep">{lead.readMinutes} min · read the piece →</p>
            </Link>
          </Reveal>
        </div>
      </section>
