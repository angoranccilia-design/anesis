...
const STATUS_LABEL: Record<string, string> = { FUNDED: "Proposed · approval required", BLOCKED: "Action blocked", INVESTIGATE: "Investigate first", REJECTED: "Rejected", DEFERRED: "Deferred (budget)" };
