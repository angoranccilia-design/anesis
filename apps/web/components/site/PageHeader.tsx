...
/** En-tête de page intérieure — même grammaire visuelle que le hero, en plus sobre (crème/encre verte). */
    ...
    <section className="relative overflow-hidden border-b border-gold/15 pt-40 pb-20">
      ...
      <div className="container-editorial relative">
        <Reveal>
          ...
          <h1 className="mt-5 max-w-4xl font-serif text-5xl font-light leading-[1.06] text-forest-900 md:text-6xl">
            {title}
          </h1>
          {lede ? (
            <p className="mt-7 max-w-2xl font-sans text-lg leading-relaxed text-forest-800/80">{lede}</p>
          ) : null}
        </Reveal>
      </div>
    </section>
